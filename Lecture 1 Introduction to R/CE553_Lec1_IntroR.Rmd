...
my_var <- 69 # btw , we can also uuse myvar = 69 
...
my_apples + my_oranges # didnt store to variables (need to store)
...
my_integer = 4L # L represent for integer
# Assign "the universe" to a variable my_character
my_character = "the universe"
# Assign FALSE to a variable my_logical
my_logical = FALSE # same as using F
...
names(poker_winnings) <- c("Monday" , "Tuesday" , "Wednesday" , "Thursday" , "Friday")
poker_vector <- names(poker_winnings)
  # call vector
poker_winnings # vector having value only
poker_vector # vector having name with value

# Assign days as names of roulette_vector
names(roulette_winnings) <- c("Monday" , "Tuesday" , "Wednesday" , "Thursday" , "Friday")        
  # Note : vector should have same length
roulette_vector <- names(roulette_winnings)
  # call vector
roulette_winnings # vector having value
roulette_vector # vector having value with name

# Create a variable days_vector that contains the days of the week.
days_vector <- c("Monday" , "Tuesday" , "Wednesday" , "Thursday" , "Friday")

# Use days_vector to set the names of poker_vector and roulette_vector
poker_vector <- poker_winnings # assign value
names(poker_winnings) <- days_vector # assign name
poker_vector # call poker_vector

roulette_vector <- roulette_winnings # assign value
names(roulette_winnings) <- days_vector # assign name
roulette_vector # call roulette_vector
```
...
total_daily <- sum(poker_winnings) + sum(roulette_winnings)
total_daily # 156
...
total_roulette <- sum(roulette_winnings)
total_roulette # -314
...
total_poker > total_roulette # TRUE -> check condition
```
...
poker_wednesday <- poker_vector[3] # Day 3 of 5
poker_wednesday 

# Select the first and fifth element of poker_vector
poker_vector[ c(1,5) ] # c("Monday" , "Friday")

# Assign the poker results of Tuesday, Wednesday and Thursday to the variable poker_midweek.
poker_midweek <- poker_vector[ c(2,3,4) ]
poker_midweek # vector of ("Tuesday" , "Wednesday" , "Thursday")
...
poker_start <- poker_vector[ c("Monday","Tuesday","Wednesday") ] # we can index elements with vector inside
poker_start
...
selection_vector <- (poker_vector > 0) # return bool of each element (like in array in python)
...
poker_winning_days
  # - get condiiton inside vector -> get TRUE elements
  # - same as poker_vector[ condition ]

# Create the variable selection_vector2, this time to see if you made profit with roulette for different days.
selection_vector2 <- (roulette_vector > 0) # return bool of each element
selection_vector2 # Mon , Wed , Fri
...
numbers1 <- matrix(1:9 , nrow = 3) # not sorting by row [ [1 4 7] [2 5 8] [3 6 9] ]
numbers2 <- matrix(1:9 , nrow = 3 , byrow = TRUE) # sorting by row [ [1 2 3] [4 5 6] [7 8 9]]

numbers1
numbers2

# Task 1 : Box office Star Wars (in millions!)
...
# Task 2 : Construct star_wars_matrix with 3 rows, where each row represents a movie. Name the resulting matrix star_wars_matrix.
star_wars_matrix = matrix(box_office , byrow = TRUE , nrow = 3) # split by row (TRUE)
...
star_wars_matrix  # not binded any column

# Task 3 : Calculate the worldwide box office figures for the three movies and put these in the vector named worldwide_vector.
worldwide_vector <- rowSums(star_wars_matrix)
worldwide_vector # call vector -> vector having name (colname) and value (summed already)

# Bind the new variable worldwide_vector as a column to star_wars_matrix
star_wars_matrix <- cbind(star_wars_matrix , worldwide_vector)
  # - add new names to matrix as column names
colnames(star_wars_matrix)[3] <- "worldwide" # column 3 = "worldwide"
  # - check if binded already 
star_wars_matrix

# Task 4 : Calculate the total revenue for the US and the non-US region and assign total_revenue_vector. You can use the colSums() function.
...
all_wars_matrix <- rbind(star_wars_matrix , total_revenue_vector)
  # name new row as total_revenue
rownames(all_wars_matrix)[4] = "total_revenue"
all_wars_matrix # call matrix 4x3
```
...
non_us_all = all_wars_matrix[ , 2] # get all row , only second column
non_us_all
...
```{r Some Examples of Arthemtic with Matrix}
mat_a <- matrix(1:9 , nrow = 3) # 3x3 matrix
double_mat_a <- 2 * mat_a
mat_a_minus_10 <- mat_a - 10

double_mat_a
mat_a_minus_10

# multiply matrix together
mat_a_square <- mat_a * mat_a # element-wise multiplication (value multiply together)
mat_a_mult_mat_a <- mat_a %*% mat_a # normal multiplication
